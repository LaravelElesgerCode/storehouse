            ...
            <div class="row">
                ...
                @if(session('mesaj1'))
                  <div class="alert alert-success text-center" role="alert">
                    <strong>{{session('mesaj1')}}</strong><br>
                  </div>
                @endif
                @if(session('mesaj2'))
                  <div class="alert alert-danger text-center" role="alert">
                    <strong>{{session('mesaj2')}}</strong><br>
                  </div>
                @endif
                

                    <form class="md-float-material form-material" method="post" action="{{route('routeuinsert')}}">
                        @csrf
                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                ...
                                <div class="form-group form-primary">
                                    ...
                                    <label class="float-label">Ad/soyadınızı qeyd edin:</label>
                                </div>
                                <div class="form-group form-primary">
                                    <input type="text" name="email" class="form-control" >
                                    <span class="form-bar"></span>
                                    <label class="float-label">Email Adresinizi qeyd edin:</label>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group form-primary">
                                            ...
                                            <span class="form-bar"></span>
                                            <label class="float-label">Parolunuzu qeyd edin:</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20">Daxil edin</button>
                                    </div>
                                </div>
                                <hr/>
                                <div class="row">
                                    <div class="col-md-10">
                                        <p class="text-inverse text-left" title="Buradan keçid elə"><a href="{{route('loginn')}}"><b>Login/Giriş</b></a></p>
                                    </div>
                                    <div class="col-md-2">
