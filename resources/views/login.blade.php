            ...
            <div class="row">
                <div class="col-sm-12">
                    <!-- Authentication card start -->
                        ...
                        <form class="md-float-material form-material" method="post" action="{{route('routeinlogin')}}">
                            @csrf
                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="form-group form-primary">
                                        ...
                                        <span class="form-bar"></span>
                                        <label class="float-label">Parol</label>
                                    </div>
                                        ...
                                        <div class="col-12">
                                            <div class="checkbox-fade fade-in-primary d-">
                                                <label>
                                                    ...
                                                    <span class="text-inverse">Xatırla</span>
                                                </label>
                                            </div>
                                            <div class="forgot-phone text-right f-right">
                                                <a href="#" class="text-right f-w-600"> Şifrəni unutdun?</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row m-t-30">
                                        <div class="col-md-12">
                                            <button type="submit" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">Daxil et</button>
                                        </div>
                                    </div>
                                    <hr/>
                                    <div class="row">
                                        <div class="col-md-10">
                                            <p class="text-inverse text-left" title="Buradan keçid elə"><a href="{{route('registrationn')}}"><b>Qeydiyyat</b></a></p>
                                        </div>
                                        <div class="col-md-2">
